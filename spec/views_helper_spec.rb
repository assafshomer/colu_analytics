...
describe "ViewsHelper" do
	describe 'multi countries per asset' do
		let(:data) { [{:piwik_id=>12372, :piwik_visitors=>"17f751cf2c1c467e", :ip=>"178.219.248.246", :country=>"Ukraine", :city=>'foo', :flag=>"plugins/UserCountry/images/flags/ua.png", :asset_id=>"LFu6pNp5FLHQu1RERkYEjPjxFZLD3zNJAbhYz"}, {:piwik_id=>12367, :piwik_visitors=>"7aeecccf21c48339", :ip=>"178.73.192.202", :country=>"Sweden", :city=>'bar', :flag=>"plugins/UserCountry/images/flags/se.png", :asset_id=>"LFu6pNp5FLHQu1RERkYEjPjxFZLD3zNJAbhYz"}, {:piwik_id=>12202, :piwik_visitors=>"8cec9dc904689695", :ip=>"178.219.248.246", :country=>"Israel", :city=>'Tel-Aviv', :flag=>"plugins/UserCountry/images/flags/ua.png", :asset_id=>"LFu6pNp5FLHQu1RERkYEjPjxFZLD3zNJAbhYz"}] }
		describe 'multi countries title' do
		  ...
		  it 'should create one line for one hash' do
		  	...
		  	create_multiline_title([{foo: 1,bar: 2}],[:foo,:bar]).should == "FOO: [1], BAR: [2]&#013;&#xA;"		  	
		  end
		end
